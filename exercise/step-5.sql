...
values('Ohiopyle State Park', 'Pennsylvania', '19650101', 19052, 1000000,
...
values((select park_id from park where park.name = 'Ohiopyle State Park'), 'Youghiogheny', 01, 12, '$95');
...
values (623, (select campground_id from campground where campground.name = 'Youghiogheny'));
insert into site (site_number, campground_id)
values (624, (select campground_id from campground where campground.name = 'Youghiogheny'));
insert into site (site_number, campground_id)
values (625, (select campground_id from campground where campground.name = 'Youghiogheny'));
...
values ((select site_id from site where site_number = 623), 'Wayne Family', CURRENT_DATE+10, CURRENT_DATE+20)

insert into reservation (site_id, name, from_date, to_date)
values ((select site_id from site where site_number = 624), 'Parker Family', CURRENT_DATE+11, CURRENT_DATE+20)

insert into reservation (site_id, name, from_date, to_date)
values ((select site_id from site where site_number = 625), 'Kent Family', CURRENT_DATE+12, CURRENT_DATE+20)
...
update reservation set to_date = CURRENT_DATE+7
where name = 'Wayne Family'
